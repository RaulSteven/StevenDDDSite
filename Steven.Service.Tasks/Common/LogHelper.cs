...
namespace Steven.Service.Tasks.Common
{
    ...
    {
        //log4net日志专用
        public static readonly log4net.ILog loginfo = log4net.LogManager.GetLogger("TaskManager");
        public static readonly log4net.ILog logerror = log4net.LogManager.GetLogger("TaskManager");
        ...
        public static void WriteTextLog(string strMessage, string path)
        {
            if (!Directory.Exists(path))
                Directory.CreateDirectory(path);

            string fileFullPath = path + "Logs_" + DateTime.Now.ToString("yyyyMMdd") + ".txt";
            StringBuilder str = new StringBuilder();
            str.Append("Time:    " + DateTime.Now + "\r\n");
            //str.Append("Action:  " +  filterContext.RouteData.Values["action"].ToString() + "\r\n");
